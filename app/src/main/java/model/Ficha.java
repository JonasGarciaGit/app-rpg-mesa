...
public class Ficha implements Serializable {
    ...
    public Ficha(String id, String idJogador, String nomeDoPersonagem, String antecedente, String classe, String nivel, String raca, String subRaca, String tendencia, String pontosDeExperiencia, String nomeDoJogador, String classeArmadura, String iniciativa, String deslocamento, String ptsForça, String ptsDestreza, String ptsConstituicao, String ptsInteligencia, String ptsSabedoria, String ptsCarisma, String pvTotais, String pvAtuais, String pvTemporario, String dadosDeVida, String total, String extraForca, String extraDestreza, String extraConstituicao, String extraInteligencia, String extraSabedoria, String extraCarisma, List<Boolean> sucesso, List<Boolean> fracasso, List<String> nomeAtaqueConjuracao, List<String> bonusAtaque, List<String> danoTipo, String ataqueCojuracaoDescricao, String pc, String pp, String pe, String po, String pl, String equipamentoDescricao, String tracosPersonalidades, String ideias, String vinculos, String defeitos, String caracteristicasTracosRaciais, String inspiracao, String bonusDeProficiencia, String sabedoriaPassiva, String txtForca, boolean forca, String txtDestreza, boolean destreza, String txtCostituicao, boolean costituicao, String txtCarisma, boolean carisma, String txtSabedoria, boolean sabedoria, String txtInteligencia, boolean inteligencia, String txtAcrobacia, boolean acrobacia, String txtAdestrarAnimais, boolean adestrarAnimais, String txtArcanismo, boolean arcanismo, String txtAtletismo, boolean atletismo, String txtAtuacao, boolean atuacao, String txtEnganacao, boolean enganacao, String txtFurtividade, boolean furtividade, String txtHistoria, boolean historia, String txtIntimidacao, boolean intimidacao, String txtInvestigacao, boolean investigacao, String txtMedicina, boolean medicina, String txtNatureza, boolean natureza, String txtPercepcao, boolean percepcao, String txtPersuasao, boolean persuasao, String txtPrestigitacao, boolean prestigitacao, String txtReligiao, boolean religiao, String txtSobrevivencia, boolean sobrevivencia, String txtIntuicao, boolean intuicao) {
        this.id = id;
